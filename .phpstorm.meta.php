...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\laravel\fx-software\public\storage' => 'string',
...
'app.version','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'filesystems.disks.s3.throw','filesystems.links.D:\\laravel\\fx-software\\public\\storage','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory',
...
'session.partitioned','view.paths','view.compiled','inertia.ssr.enabled','inertia.ssr.url',
...
'debugbar.queries.explain','boost.browser-logs','sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution',
'ignition.updateConfig','login','password.request',
'password.email','password.reset','password.store','verification.notice','verification.verify',
'verification.send','password.confirm','password.update','logout','customers.waiver','customers.waiver.store','dashboard','profile.edit',
'profile.update','profile.destroy','filepond.upload','filepond.revert','filepond.remove',
'users.index','users.create','users.store','users.edit','users.update',
'users.destroy','branches.set.current','branches.index','branches.store','branches.edit',
'branches.update','branches.destroy','product-categories.index','product-categories.store','product-categories.edit',
'product-categories.update','product-categories.destroy','get.searched.products','get.product','products.update',
'products.index','products.create','products.store','products.show','products.edit',
'products.destroy','quotations.index','quotations.create','quotations.store','quotations.show',
'quotations.edit','quotations.update','quotations.destroy','event-quotations.index','event-quotations.create',
'event-quotations.store','event-quotations.show','event-quotations.edit','event-quotations.update','event-quotations.destroy',
'get.searched.customers','customers.index','customers.create','customers.store','customers.show',
'customers.edit','customers.update','customers.destroy','roles.index','roles.create',
'roles.store','roles.edit','roles.update','roles.destroy','currencies.index',
'currencies.store','currencies.edit','currencies.update','currencies.destroy','payment-methods.index',
'payment-methods.store','payment-methods.edit','payment-methods.update','payment-methods.destroy','taxes.index',
'taxes.store','taxes.edit','taxes.update','taxes.destroy','discounts.index',
'discounts.store','discounts.edit','discounts.update','discounts.destroy','units.index',
'units.store','units.edit','units.update','units.destroy','event-types.index',
'event-types.store','event-types.edit','event-types.update','event-types.destroy','activity-logs.destroy.multiple',
'activity-logs.index','activity-logs.destroy','settings.edit','settings.update',);
        registerArgumentsSet('views', 
'app','errors.401','errors.402','errors.403','errors.404',
'errors.419','errors.429','errors.500','errors.503','errors.layout',
'errors.minimal','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.laravel.fx-software.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_VERSION','DEBUGBAR_ENABLED','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
